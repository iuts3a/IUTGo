...
public class RoadTrip implements Serializable {
    ...
    public static void createSaveFile() throws IOException {
        ...
        HashMap<String, RoadTrip> hashMap = new HashMap<>();
    ...
    public String toString() {
        StringBuilder pointInterestToString = new StringBuilder();
        StringBuilder participantsToString = new StringBuilder();

        for (PointInterest p : getPointInterests().values()) {
            pointInterestToString.append("\n\t\t").append(p);
        }

        for (User u : getParticipants().values()) {
            participantsToString.append("\n\t\t").append(u);
        }
